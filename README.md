...
This repository is for SunFounder Rollarm Kit. you can buy it on [our website](https://www.sunfounder.com/), or search sunfounder in Amazon.
...
<a id="license"></a>
## License
This is the code for SunFounder Rollarm Kit.
...
Rollarm Kit comes with ABSOLUTELY NO WARRANTY; for details run ./show w. This is free software, and you are welcome to redistribute it under certain conditions; run ./show c for details.

SunFounder, Inc., hereby disclaims all copyright interest in the program 'Rollarm Kit' (which makes passes at compilers).
